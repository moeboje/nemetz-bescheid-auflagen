...
type AdminSubnavItem = {
  key: "users" | "roles" | "externalOrgs" | "authorities" | "security";
  path: string;
  labelKey: "admin.nav.users" | "admin.nav.roles" | "admin.nav.externalOrgs" | "admin.nav.authorities" | "admin.nav.security";
};
